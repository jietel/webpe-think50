...
final class Loader
{
    ...
    /**
     * 注册自动加载机制(@jayter修改：自动加载Composer改为手动调用registerComposerLoader)
     * @access public
    ...
    public static function register($autoload = null)
    {
        ...
        // Composer 自动加载改为手动调用registerComposerLoader
    ...
    /**
     * 注册 composer 自动加载(jayter改为手动调用)
     * @access public
     * @return void
     */
    public static function registerComposerLoader()
    {
    ...
    private static function loadComposerAutoloadFiles()
    {
     ...
     */
    public static function model($name = '', $layer = 'model', $appendSuffix = false, $common = 'xweb')
    {
        $uid = $name . $layer;
     ...
     * @throws ClassNotFoundException
     */
    public static function validate($name = '', $layer = 'validate', $appendSuffix = false, $common = 'xweb')
    {
    ...
    public static function appError($errno, $errstr, $errfile = '', $errline = 0){
    	\think\Error::appError($errno, $errstr,$errfile,$errline);
    }
